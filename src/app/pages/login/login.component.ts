...
export class LoginComponent implements OnInit {
    ...
    setUserInfo(user1: any) {
        ...
        this._userServ.getUserInformation(this.logindata.data.ticket, this.userdata.userName).subscribe(resdata => this.userInfo = resdata, reserror => this.errorMsg = reserror, () => {
